...
export default function AgreementForm() {
  ...
  const form = useForm<AgreementData>({
    ...
    defaultValues: {
      ...
      guestPolicy: "Overnight guests are allowed for a maximum of 3 consecutive nights and no more than 7 nights per roommate per month. Roommates must provide 24-hour notice to other roommates for any overnight guest.",
      noisePolicy: "Quiet hours are from 11 PM to 7 AM on weeknights (Sunday-Thursday) and 1 AM to 9 AM on weekends (Friday-Saturday).",
      partyPolicy: "Parties or large gatherings of more than 5 guests must be approved by all roommates at least 48 hours in advance. The host is responsible for all guests and for cleaning up afterwards.",
      ...
      sharedProperty: "Living room furniture (sofa, coffee table, TV stand) and kitchen appliances are considered shared property unless stated otherwise.",
